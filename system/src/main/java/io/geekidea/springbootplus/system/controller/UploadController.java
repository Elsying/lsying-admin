...
public class UploadController {
    ...
    @ApiOperation(value = "上传多个文件", response = ApiResult.class)
    @ApiImplicitParams({
//            @ApiImplicitParam(name = "file", value = "文件", required = true,dataType = "__file"),
            @ApiImplicitParam(name = "files",value = "多个文件，",paramType = "formData",allowMultiple=true,required = true,dataType = "file"),
    })
    public ApiResult<List<String>> uploads(@RequestParam("files") MultipartFile[] multipartFilelist) throws Exception {
