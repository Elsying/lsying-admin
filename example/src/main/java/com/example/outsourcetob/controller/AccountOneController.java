...
public class AccountOneController extends BaseController {
    ...
    public ApiResult<Boolean> addAccountOne(@Validated(Add.class) @RequestBody AccountOne accountOne) throws Exception {
        boolean flag = accountOneService.saveAccountOne(accountOne);
    ...
    public ApiResult<AccountOne> getAccountOne(@PathVariable("id") Long id) throws Exception {
        AccountOne accountOne = accountOneService.getById(id);
        return ApiResult.ok(accountOne);
    }
