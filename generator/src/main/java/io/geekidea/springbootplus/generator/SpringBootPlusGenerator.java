...
//        generatorProperties.setTablePrefix(Arrays.asList("tb_","shop_"));
        ...
        generatorProperties.getDataSourceConfig()
                ...
                .setUsername("root")
                .setPassword("H1Eb$1Z^djqJpXtK")
                .setDriverName("com.mysql.jdbc.Driver")
                .setUrl("jdbc:mysql://116.62.196.62:3306/lsying?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf8&useSSL=false&allowPublicKeyRetrieval=true");
